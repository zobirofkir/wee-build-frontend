...
const ApplyThemeButtonComponent = ({
  selectedTheme,
  themes,
  applyLoading,
  applyProgress,
      ...
      {selectedTheme && (
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 p-4 shadow-lg border-t border-gray-200 dark:border-gray-700 z-10">
          <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0">
            <p className="text-gray-700 dark:text-gray-300 font-medium text-sm sm:text-base text-center sm:text-left">
              Theme selected:{" "}
            ...
            <button
              ...
              className={`w-full sm:w-auto py-2 px-6 relative overflow-hidden ${
